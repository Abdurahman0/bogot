...
const PERMISSION_LABELS = {
  uz: {
    ...
    "debtors.view": "Qarzdorlarni ko'rish",
    "debtors.manage": "Qarzdorlarni boshqarish",
  ...
  ru: {
    ...
    "debtors.view": "Просмотр должников",
    "debtors.manage": "Управление должниками",
